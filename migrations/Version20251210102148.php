 ...
 */
final class Version20251210102148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coaster ADD max_height INT DEFAULT NULL, CHANGE mex_height park_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coaster ADD mex_height INT DEFAULT NULL, DROP park_id, DROP max_height');
    }
}
